...
import testahget from './test/ah/get';
import testahpost from './test/ah/post';
import testahpatch from './test/ah/patch';
...
export const API = {
  hello: hello,
  test: { ah: { get: testahget, post: testahpost, patch: testahpatch } },
  user: {
    getMe: usergetMe,
